...
Praeparo’s metrics tooling lets you turn YAML metric definitions (and their variants) into reusable, validated DAX expressions.

Key docs:

- [Metric → DAX Builder](metric_dax_builder.md)
- [TMDL Generation](tmdl_generation.md)
- [Metric Debugging](metric_debugging.md)
